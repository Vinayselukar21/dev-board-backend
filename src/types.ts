...
export enum PermissionType {
  ...
  CREATE_CUSTOM_WORKSPACE_ROLE = 'CREATE_CUSTOM_WORKSPACE_ROLE',// new
  EDIT_CUSTOM_WORKSPACE_ROLE = 'EDIT_CUSTOM_WORKSPACE_ROLE',// new
  DELETE_CUSTOM_WORKSPACE_ROLE = 'DELETE_CUSTOM_WORKSPACE_ROLE',// new
...
export enum OrgPermissionType {
  ...
  CREATE_CUSTOM_ORG_ROLE = 'CREATE_CUSTOM_ORG_ROLE',// new
  EDIT_CUSTOM_ORG_ROLE = 'EDIT_CUSTOM_ORG_ROLE',// new
  DELETE_CUSTOM_ORG_ROLE = 'DELETE_CUSTOM_ORG_ROLE',// new
}
