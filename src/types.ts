...
export enum PermissionType {
  ...
  CREATE_CUSTOM_WORKSPACE_ROLE = 'CREATE_CUSTOM_WORKSPACE_ROLE',
  EDIT_CUSTOM_WORKSPACE_ROLE = 'EDIT_CUSTOM_WORKSPACE_ROLE',
  DELETE_CUSTOM_WORKSPACE_ROLE = 'DELETE_CUSTOM_WORKSPACE_ROLE',
}
