...
async function mapPermissionWithRoles(workspaceId: string, organizationId: string) {
  ...
  const roleMap = {
    owner:  ['ALL_PROJECT', 'ALL_TASK', 'CHANGE_MEMBER_ROLE', 'CREATE_EVENT', 'CREATE_PROJECT', 'CREATE_TASK', 'DELETE_EVENT', 'DELETE_PROJECT', 'DELETE_TASK', 'EDIT_ANY_EVENT', 'EDIT_ANY_TASK', 'EDIT_EVENT', 'EDIT_PROJECT', 'ADD_MEMBER', 'REMOVE_MEMBER', 'VIEW_PROJECT', 'VIEW_TASK'],
    admin:  ['ALL_PROJECT', 'ALL_TASK', 'CHANGE_MEMBER_ROLE', 'CREATE_EVENT', 'CREATE_PROJECT', 'CREATE_TASK', 'DELETE_EVENT', 'DELETE_PROJECT', 'DELETE_TASK', 'EDIT_ANY_EVENT', 'EDIT_ANY_TASK', 'EDIT_EVENT', 'EDIT_PROJECT', 'ADD_MEMBER', 'REMOVE_MEMBER', 'VIEW_PROJECT', 'VIEW_TASK'],
